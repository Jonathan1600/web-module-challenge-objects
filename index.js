...
function createMenuItem(namev, pricev, categoryv) {
  return { name: namev, price: pricev, category: categoryv }
}
...
console.log(createMenuItem("carne asada", 5, "dinner"))
...
*/
reviews.push({ name: "jimbo", rating: 1, feedback: "muy bueno" });
console.log(reviews);
